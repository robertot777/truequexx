...
import truequep.config.audit.AuditEventConverter;
import truequep.domain.PersistentAuditEvent;
...
import static truequep.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
